...
export const Users = ({ onClickSuccess, invites, onClickInvite, items, isLoading, searchValue, setSearchValue }) => {
  ...
  return (
    <>
      <div className="search">
        ...
        <input value={searchValue} onChange={(event) => onChangeValue(event)} type="text" placeholder="Найти пользователя..." />
      </div>
      {isLoading ? (
